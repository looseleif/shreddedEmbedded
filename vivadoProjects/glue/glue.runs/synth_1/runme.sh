...
HD_PWD='C:/Users/FemtoFluidics/Documents/GitHub/vivadoRepository1/glue/glue.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMF_Translation_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMF_Translation_wrapper.tcl
