...
HD_PWD='C:/Users/FemtoFluidics/Desktop/glue/glue.runs/DMF_Translation_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMF_Translation_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMF_Translation_ilmb_v10_0.tcl
