...
ISEStep( "vivado",
         "-log DMF_Translation_axi_ethernetlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMF_Translation_axi_ethernetlite_0_0.tcl" );
