...
HD_PWD='C:/Users/FemtoFluidics/Documents/GitHub/vivadoRepository1/glue/glue.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DMF_Translation_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DMF_Translation_wrapper.tcl -notrace
