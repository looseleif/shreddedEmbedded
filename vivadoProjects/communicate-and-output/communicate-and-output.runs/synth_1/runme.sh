...
HD_PWD='C:/Users/FemtoFluidics/Documents/GitHub/vivadoRepository1/communicate-and-output/communicate-and-output.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uBlaze_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uBlaze_wrapper.tcl
