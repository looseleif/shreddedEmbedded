...
HD_PWD='C:/Users/FemtoFluidics/Documents/GitHub/vivadoRepository1/communicate-and-output/communicate-and-output.runs/uBlaze_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uBlaze_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uBlaze_axi_gpio_0_0.tcl
