...
HD_PWD='C:/Users/FemtoFluidics/Documents/GitHub/vivadoRepository1/communicate-and-output/communicate-and-output.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uBlaze_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uBlaze_wrapper.tcl -notrace
