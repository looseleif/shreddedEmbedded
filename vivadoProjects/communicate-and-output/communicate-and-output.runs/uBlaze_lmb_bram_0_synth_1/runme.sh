...
HD_PWD='C:/Users/FemtoFluidics/Documents/GitHub/vivadoRepository1/communicate-and-output/communicate-and-output.runs/uBlaze_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uBlaze_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uBlaze_lmb_bram_0.tcl
